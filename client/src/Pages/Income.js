...
import { createIncAction } from "../Redux/Slices/incomeSlices";
    ...
    return (
        ...
        <div className="max-w-md w-full space-y-8">
            <div>
                ...
                alt="Workflow"
                />
                <h2 className="mt-6 text-center text-3xl font-extrabold text-gray-900">Income</h2>
